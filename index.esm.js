...
const Request = ({ operation: { request, request: { path: pathParams = [], headers: headerParams = [], cookie: cookieParams = [], body, query: queryParams = [], } = {}, security, }, hideSecurityInfo, onChange, isHttpWebhookOperation = false, }) => {
    ...
    return (React.createElement(VStack, { spacing: 8 },
        ...
        hideSecurityInfo ? null : React.createElement(SecuritySchemes$1, { schemes: securitySchemes, parentId: operation.id }),
...
const ServerInfo = ({ servers, mockUrl }) => {
    ...
    const serversToDisplay = React.useMemo(() => getServersToDisplay(servers, $mockUrl), [servers, $mockUrl]);
...
const HttpServiceComponent = React.memo(({ data: unresolvedData, location = {}, layoutOptions, exportProps }) => {
    ...
    return (React.createElement(Box, { ref: layoutRef, mb: 10, className: "HttpService" },
        ...
        React.createElement(VStack, { spacing: 6 },
            (layoutOptions === null || layoutOptions === void 0 ? void 0 : layoutOptions.hideServerInfo) ? null : React.createElement(ServerInfo, { servers: (_b = data.servers) !== null && _b !== void 0 ? _b : [], mockUrl: mocking.mockUrl }),
            (layoutOptions === null || layoutOptions === void 0 ? void 0 : layoutOptions.hideSecurityInfo) ? null : (React.createElement(Box, { "data-test": "security" }, ((_c = data.security) === null || _c === void 0 ? void 0 : _c.length) ? (React.createElement(SecuritySchemes, { secSchemes: data.security, defaultScheme: query.get('security') || undefined, parentId: data.id })) : null)),
